      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
              <div className="flex items-start gap-4 mb-6">
                <Eye className="w-8 h-8 text-cyan-600 shrink-0 mt-1" />
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
              <div className="flex items-start gap-4 mb-6">
                <Cookie className="w-8 h-8 text-cyan-600 shrink-0 mt-1" />
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">
            ...
            <div className="bg-cyan-50 border-2 border-cyan-200 rounded-2xl p-8 md:p-12 mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
              <div className="flex items-start gap-4 mb-6">
                <Lock className="w-8 h-8 text-cyan-600 shrink-0 mt-1" />
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">
                    Data Security
                  </h2>
            ...
            {/* <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                Our website is operated from Israel and our services are
                provided globally through Amazon&apos;s international platforms.
                If you are accessing our website from outside Israel, please be
                aware that your information may be transferred to, stored, and
                processed in Israel and other countries where our service
                providers operate. By using our website, you consent to the
            ...
            <div className="bg-linear-to-r from-cyan-500 to-sky-600 rounded-2xl p-8 md:p-12 text-white">
              <div className="flex items-start gap-4 mb-6">
                <Mail className="w-8 h-8 text-cyan-600 shrink-0 mt-1" />
                <div className="flex-1">
            ...
            <div className="bg-sky-50 border-2 border-sky-200 rounded-2xl p-8 md:p-12 mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
